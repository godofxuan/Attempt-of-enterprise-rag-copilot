...
def test_schema_rejects_incorrect_first_loss_or_coverage() -> None:
    ...
    with pytest.raises(ValidationError, match="coverage mismatch"):
        MultiDocAttributionCase(
            ...
            controller_terminal_tool="answer",
            ...
            final_response_mode="answered",
            final_response_stop_reason="completed",
            unsupported_citation_count=0,
            grounding_gate_reason_codes=[],
            grounding_gate_downgraded_response=False,
