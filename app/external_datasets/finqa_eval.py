...
def _build_program_messages(
    ...
    system_prompt = (
        ...
        "for 52.8 percent return a program yielding 0.528, not 52.8. For increase, "
        "decrease, decline, growth, or percentage change, calculate the signed "
        "difference and divide by the old value; do not stop at the difference. For "
        "portion or what-percent questions, divide the part by the total. For ratios, "
        "complete the requested comparison. Match the exact years, periods, and "
        "categories named in the question; never substitute another row or period. "
