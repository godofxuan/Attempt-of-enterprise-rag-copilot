...
def create_app_v2(assembly: FinQAServiceAssemblyV2 | None = None) -> FastAPI:
    active = assembly or build_finqa_service_assembly_v2(get_settings())
    ...
    application.state.finqa_service_assembly = active
    application.state.service_profile = "secure-v2"
    ...
    def agent_v2_chat(
        ...
        with trace_span("agent.run"):
            answer = active.agent_runner.run(
                payload.question,
    ...
    def metrics(request: Request) -> dict:
        ...
        snapshot["finqa_typed_observation"] = safe_finqa_service_snapshot_v2(
            active.runtime
        )
        return snapshot
