...
| E7 direct prompt-injection probes | `4/4` safe pre-retrieval refusals | Direct user prompts only; retrieved-content injection is `NOT RUN` |
...
- Indirect prompt injection inside retrieved documents is `NOT RUN` because this corpus version has no dedicated fixture.
