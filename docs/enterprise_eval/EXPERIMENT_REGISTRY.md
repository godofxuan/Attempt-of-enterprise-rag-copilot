...
| ENT-E2-001 | `NOT_FROZEN` | EnterpriseRAG-Bench official full corpus | Current system establishes category-level heterogeneous enterprise baseline | B0/B1/B2/B3 | CAPACITY_BLOCKED | Questions/schema verified; 1.41 GB corpus not downloaded; current in-memory builder not qualified under 16.95 GiB free RAM |
