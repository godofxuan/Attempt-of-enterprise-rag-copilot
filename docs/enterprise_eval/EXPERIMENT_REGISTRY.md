...
| ENT-E2-B0-001 | `NOT_FROZEN` | EnterpriseRAG-Bench 470 document-grounded questions / full 511,962-row corpus | Disk-backed FTS5 can establish a bounded full-corpus lexical baseline | BM25 FTS5 B0 | PROTOCOL_FROZEN_NOT_RUN | Protocol `ENTERPRISE_RAG_BENCH_RETRIEVAL_PROTOCOL_V1.json`; no source-type oracle, answer generation, or candidate tuning |
