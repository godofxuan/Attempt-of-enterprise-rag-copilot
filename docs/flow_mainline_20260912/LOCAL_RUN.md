...
.\scripts\local_candidate.ps1 -Action Start -PythonPath 'D:\文档\agent\RAG_try\.venv\Scripts\python.exe' -IndexRoot 'D:\文档\agent\RAG_try\data\indexes_v2' -ApiPort 8012 -UiPort 8512
```
