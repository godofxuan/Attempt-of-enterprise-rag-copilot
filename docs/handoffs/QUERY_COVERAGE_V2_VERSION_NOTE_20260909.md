...
```text
canonical public checkout          LOCAL_PATH_REDACTED
canonical public HEAD              c9984e92a10a6f417e2c1d8082af7e8f1e11aee1
candidate working tree             LOCAL_PATH_REDACTED
...
candidate checkout                 LOCAL_PATH_REDACTED
...
`LOCAL_PATH_REDACTED`. This record authorizes no application,
