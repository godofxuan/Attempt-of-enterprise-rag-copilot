...
|---|---|---|---|---|
| A1 host-controlled RAG | P5 | mechanism tests only | Architecture breadth can be mistaken for quality | Agent improved accuracy; semantic entailment guaranteed |
...
| Bullet | Evidence claim | Metric | Main risk | Forbidden stronger wording |
|---|---|---|---|---|
| B1 evaluation evidence chain | P1-P6/N1 | schema/hash/test bindings | Mechanism count is not model quality | comprehensive external validation |
...
| C3 API boundaries | P5 | deterministic portfolio gate | local simulated identity | enterprise SSO; production SLO |
