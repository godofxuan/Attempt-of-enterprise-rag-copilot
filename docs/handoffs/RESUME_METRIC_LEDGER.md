...
| HISTORICAL_NEGATIVE | UDA R4 hierarchical validation | Hit@5 `76.56% -> 81.25%` (+4.69pp); nDCG@5 `64.41% -> 72.61%`; p95 `112.65 -> 120.06 ms` | 64 company-disjoint external validation questions, known report | Candidate missed the preregistered +5pp Hit@5 gate by 0.3125pp; test forbidden | "Rejected a candidate despite nDCG gain because the joint validation gate failed" | "Promoted RAG quality by 8.20pp" or any test/general accuracy claim | `docs/r4/evidence/uda_finance_r4_public_v1.json` |
