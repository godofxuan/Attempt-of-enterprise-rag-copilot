...
| `E5-I06` | full pytest 108 个 tmp_path setup WinError 5 | `%TEMP%/pytest-of-xuan` ACL protected 且无当前用户显式访问 | 验证位于用户 TEMP 后只恢复该目录 ACL 继承/权限 | `[OBSERVED]` 417 pass/108 error -> 525 pass | [E5-C07](e5_security_service_observability_implementation.md#14-e5-c07确定性-ci-与测试配置) |
